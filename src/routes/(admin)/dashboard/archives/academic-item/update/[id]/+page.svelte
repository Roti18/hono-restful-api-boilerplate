<script lang="ts">
	...
	let selectedMataKuliahId = item?.mataKuliahId || data.mataKuliahs?.[0]?.id || 0;
	...
	let selectedType = item?.type || 'tugas';
...
<div class="mx-auto max-w-4xl p-6">
	...
	<div class="mb-8">
		<h1 class="text-2xl font-bold text-white">Edit Academic Item</h1>
		<p class="text-zinc-500">Update assignments, materials, or exams.</p>
	</div>
		...
		<div class="space-y-4 rounded-lg border border-zinc-800 bg-zinc-900/50 p-6">
			...
			<div>
				...
				<Input
					...
					name="title"
					bind:value={title}
					placeholder="e.g. Tugas 1: Kalkulus Dasar"
					required
				/>
			</div>
